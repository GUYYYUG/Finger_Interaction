...
//                            /*在此处添加文件路径*/
////                            tcpClient.sendFile("NewTextFile.txt","/Download/Log 2022-02-23 17_40_19.txt");
//                            if(cnt==0){
//                                tcpClient.sendFile("1.txt","/Download/realtime_log_20220225164423_1645778663..txt");
//                                cnt ++;
//                            }
//                            else if(cnt==1){
//                                tcpClient.sendFile("2.txt","/Download/realtime_log_20220225170359_1645779839..txt");
//                                cnt++;
//                            }
//                            else if(cnt==2){
//                                tcpClient.sendFile("3.txt","/Download/realtime_log_20220225172329_1645781009..txt");
//                                cnt++;
//                            }
//                            else if(cnt==3){
//                                tcpClient.sendFile("4.txt","/Download/realtime_log_20220414214917_1649944157..txt");
//                                cnt++;
//                            }
//                            Log.v("run",String.valueOf(cnt));
//                        }
//                    });
//                    break;
//            }

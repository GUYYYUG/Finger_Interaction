package com.example.gldemo.base;
...
//        Matrix.setRotateM(currMatrix, 0, angle, x, y, z);
    }
    public void rotate2(float angle, float x, float y, float z)//设置绕xyz轴移动
    {
//        Matrix.rotateM(currMatrix, 0, angle, x, y, z);
        Matrix.setRotateM(currMatrix, 0, angle, x, y, z);
    }
...
//        Log.e("view", Arrays.toString(mVMatrix));

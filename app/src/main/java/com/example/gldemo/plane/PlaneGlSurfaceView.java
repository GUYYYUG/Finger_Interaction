package com.example.gldemo.plane;
...
public class PlaneGlSurfaceView extends GLSurfaceView {
    ...
    public void MyDraw(GokuRenderer gokuRenderer,float roll_d,float yaw_d,float pitch_d,int mode ){
        gokuRenderer.DrawWithButton(roll_d,yaw_d,pitch_d,mode);
    }
